...
let { nanoid } = __webpack_require__(2618)
...
const htmlparser = __webpack_require__(5106);
 ...
 */
var foreignNames_js_1 = __webpack_require__(2734);
...
var stringify_js_1 = __webpack_require__(5283);
var legacy_js_1 = __webpack_require__(9473);
/**
...
var domhandler_1 = __webpack_require__(1142);
/**
...
__exportStar(__webpack_require__(5283), exports);
__exportStar(__webpack_require__(7972), exports);
__exportStar(__webpack_require__(4541), exports);
__exportStar(__webpack_require__(2764), exports);
...
var domhandler_1 = __webpack_require__(1142);
var querying_js_1 = __webpack_require__(2764);
/**
...
var domhandler_1 = __webpack_require__(1142);
var dom_serializer_1 = __importDefault(__webpack_require__(8427));
var domelementtype_1 = __webpack_require__(9960);
/**
 * @category Stringify
...
var Tokenizer_js_1 = __importStar(__webpack_require__(34));
var decode_js_1 = __webpack_require__(4076);
...
var Parser_js_1 = __webpack_require__(6666);
var Parser_js_2 = __webpack_require__(6666);
Object.defineProperty(exports, "Parser", ({ enumerable: true, get: function () { return Parser_js_2.Parser; } }));
var domhandler_1 = __webpack_require__(1142);
var domhandler_2 = __webpack_require__(1142);
...
var Tokenizer_js_1 = __webpack_require__(34);
...
var domutils_1 = __webpack_require__(7241);
var domutils_2 = __webpack_require__(7241);
...
exports.DomUtils = __importStar(__webpack_require__(7241));
//# sourceMappingURL=index.js.map
...
function populateTodoForm(todo) {
	...
	todoForm.querySelector('#todoDueDate').value = format(
		todo.dueDate,
		'yyyy-MM-dd',
	);
...
function updateProject(updatedProject) {
	...
	if (isProjectLiActive) {
		...
		setTodosTitle(sanitize_html_default()(updatedProject.title));
	}
...
function switchProject(project, todos) {
	...
	setTodosTitle(sanitize_html_default()(project.title));
	clearTodoList();
	renderTodos(todos);
}
...
function create(projectInfo) {
	const project = { id: esm_browser_v4(), ...projectInfo };
	add('projects', project);
	EE.emit('project-created', project);
	return project;
}

function Project_findByIdAndUpdate(projectId, updatedProjectInfo) {
...
function Project_deleteById(projectId) {
	deleteById('projects', projectId);
	deleteMany('todos', { projectId });
...
function Todo_findByIdAndUpdate(todoId, updatedTodoInfo) {
	const updatedTodo = findByIdAndUpdate(
		'todos',
		todoId,
		updatedTodoInfo,
	);
...
function Todo_deleteById(todoId) {
...
function addEvents() {
	...
	EE.on('will-populate-project-form', (projectId) => {
		const project = Project_find({ id: projectId })[0];
		populateProjectForm(project);
	});

	EE.on('will-update-project', (projectId, updatedProjectInfo) => {
		Project_findByIdAndUpdate(projectId, updatedProjectInfo);
	});
	...
	EE.on('deleted-active-project-li', () => {
		const projects = Project_find({});
		const firstProject = projects[0];
		if (firstProject) {
			const firstProjectTodos = Todo_find({ projectId: firstProject.id });
	...
	EE.on('will-complete/uncomplete-todo', (todoId) => {
		const todo = Todo_find({ id: todoId })[0];
		const updatedTodoInfo = { ...todo, complete: !todo.complete };
		Todo_findByIdAndUpdate(todoId, updatedTodoInfo);
	});
...
;// CONCATENATED MODULE: ./src/js/addDummyInitialElements.js
...
function addDummyInitialElements() {
	// Projects
	const defaultProject = create({ title: 'Default' });
	const workoutProject = create({ title: 'Workout' });
...
/* harmony default export */ const js_addDummyInitialElements = (addDummyInitialElements);

;// CONCATENATED MODULE: ./src/js/addInitialElements.js
...
/* harmony default export */ const js_addInitialElements = (addInitialElements);
...
document.addEventListener('DOMContentLoaded', () => {
	...
	if (localStorage.getItem('projects') === null) {
		js_addDummyInitialElements();
	} else {
		js_addInitialElements();
	}
	determineAddTodoDisplay();
	addFormValidations();
	addEventListeners();
